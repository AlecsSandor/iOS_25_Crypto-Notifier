...
public struct Colors {
    // my color
    public static let GradientUpperGreen:Color = Color(hexString: "#6BD25F")
    public static let GradientLowerGreen:Color = Color(hexString: "#52BA46")
...
public struct GradientColors {
    ...
    //custom
    public static let customGrd = GradientColor(start: Color(hexString: "52BA46"), end: Color(hexString: "6BD25F"))
}

public struct Styles {
    
    // My own style
    public static let barChartStyleGreen = ChartStyle(
        backgroundColor: .clear,
        accentColor: Colors.GradientLowerGreen,
        secondGradientColor: Colors.GradientUpperGreen,
...
public struct ChartForm {
    ...
    public static let custom = CGSize(width:360, height:240)
    #endif
}
